...
(6 ошибок) при `k = 4`. Попытаемся улучшить его с помощью **STOLP**, сократив
количество ошибок в 2 раза.

С поставленной задачей алгоритм справился за 12 проходов (где-то за
полминуты), допустив всего _3 ошибки_ на эталонной выборке:

![STOLP...](IMG/STOLP.png)

Как можно заметить, выборка сократилась со 150-ти до 12-ти объектов (в 12,5 раз),
тем самым ускорим время классификации.
