...
mc.draw.LOO.KNN = function(points, classes) {
    ...
    plot(x, y, type = "l", main = "LOO для KNN", xlab = "K", ylab = "LOO", col.lab = "blue")
...
mc.draw.KNN = function(points, classes, colors, k) {
    ...
    plot(points, bg = colors[classes], pch = 21, asp = 1, xlim = xlim, ylim = ylim, main = "Карта классификации KNN", col.lab = "blue") #Рисуем известные точки
